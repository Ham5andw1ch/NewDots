...
awful.screen.connect_for_each_screen(function(s)
  ...
  -- Create a tasklist widget
   ...
   s.mywibox= wibox({ y = 0, x = s.geometry.x + 30, stretch = false, type ="dock", ontop = true, screen = s,height = 23, width = s.geometry.width - 30, struts = { top = 30 }  })
   ...
   s.mywidock= awful.wibar({ opacity = 1, position = "left", type ="dock", ontop = true, screen = s, width = 30 })
